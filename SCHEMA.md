# 📋 Schema SQL - Referência Rápida

## Para copiar e colar diretamente no Supabase SQL Editor:
...
2. Vá em SQL Editor
3. Copie TODO o código SQL acima
4. Cole no editor e clique em RUN
5. Pronto! ✅

## Precisa de mais detalhes?
Veja o [SETUP_DATABASE.md](SETUP_DATABASE.md) para guia completo passo-a-passo.
